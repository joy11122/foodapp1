...
const d=await result.json()
    localStorage.setItem("Restaurant",JSON.stringify(d.data))
        ...
        <div className=" p-3">
          <div className="row d-flex justify-content-center align-items-center ">
            <div className="col-md-6 p-3 border text-center">
              <h2 className="mb-4 mt-3">Restaurant Registration </h2>
              ...
              <div className="mt-3 w-100 gap-2 d-flex">
                <div className="w-50">
                  ...
                  />
                  {error &&  <span className="text-warning">Password not Matched</span>}
                </div>
                <div className="w-50">
                  <input
                    value={cpassword}
